    ...
    <nav class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start position-absolute ms-3 bg-white loopple-fixed-start" id="sidenav-main" data-sidebar="true" data-sidebar-value="53">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="javascript:;">
                ...
                <span class="ms-1 font-weight-bold">Lunaris Media Group</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="./page3_duplicate_of_page2_duplicate_of_index.html">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <div class="card p-3 mb-4">
                        <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url(https://demos.creative-tim.com/soft-ui-dashboard/assets/img/ivancik.jpg);">
                            ...
                            <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                                <h5 class="text-white font-weight-bolder mb-4 pt-2">VISA</h5>
                                <p class="text-white">6662 7719 8882 8882 9940</p>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <h5 class="font-weight-bolder">$89329.31</h5>
                                        <p class="mb-5">$50 left until paid</p>
            ...
            <div class="row mb-4 removable">
                ...
                <div class="col-lg-7">
                    <div class="card mb-4">
                        ...
                        <div class="card-body p-3">
                            <canvas id="chart-line" class="chart-canvas chartjs-render-monitor" height="298" width="721" style="display: block; height: 298px; width: 721px; box-sizing: border-box;"></canvas>
